...
/** Menerapkan satu perubahan ke data cache lokal (dipakai baik saat offline maupun setelah sinkron sukses). */
...
/** Mencoba kirim semua perubahan yang tertunda ke server. Berhenti begitu satu gagal karena koneksi. */
export async function flushQueue() {
  ...
  for (const change of queue) {
    try {
      ...
      // Kemungkinan masih offline — hentikan, coba lagi lain kali
      break;
    }
  }
