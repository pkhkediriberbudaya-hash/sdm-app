...
/**
 * Membaca seluruh isi sebuah sheet/tab.
 * Baris pertama dianggap header. Setiap record diberi field `_row`
 * yaitu nomor baris asli di spreadsheet (untuk keperluan update/delete).
 */
...
/** Menambah baris baru di akhir sheet. */
...
/** Menimpa satu baris (berdasarkan nomor baris asli di sheet). */
...
/** Menghapus satu baris (berdasarkan nomor baris asli di sheet). */
...
/** Memastikan sebuah sheet/tab ada; membuatnya kalau belum ada. */
...
/** Mengosongkan seluruh isi sebuah sheet (dipakai sebelum tulis ulang massal). */
...
/**
 * Menulis ulang SELURUH isi sheet dalam SATU kali panggilan API (jauh lebih
 * efisien daripada update baris satu-satu untuk data ribuan baris seperti KPM).
 * Sebaiknya dipanggil setelah clearSheetRange().
 */
...
/** Mengambil daftar nama semua sheet/tab dalam spreadsheet. */
